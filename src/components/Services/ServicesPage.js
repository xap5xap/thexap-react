                ...
                <div className="container-fluid bg-3 text-center">
                    ...
                    <div className="row">
                        <div className="col-sm-4">
                            ...
                            <img src="/assets/img/web.svg" alt="Image" width="150" height="100" />
                        </div>
                        <div className="col-sm-4">
                            ...
                            <img src="/assets/img/mobilephone.svg" alt="Image" width="150" height="100" />
                        </div>
                        <div className="col-sm-4">
                            <h2>Technologies</h2>
                            ...
                            <img src="/assets/img/tools.svg" alt="Image" width="150" height="100" />
                        </div>
                    </div>
                </div>
            </div>
